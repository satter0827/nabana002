...
urlpatterns = [
  ...
  path('result_updateindex/', views.RecViewBySVD.as_view(), name='result_updateindex'),
  path('result_updateindex_KNN/', views.RecViewByKNN.as_view(), name='result_updateindex_KNN'),
